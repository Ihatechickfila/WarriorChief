...
Window_Base.prototype.drawActorLustBar = function(actor, x, y, width) {

    width = width || 186;
    var color1 = actor.corruption < 0 ? this.textColor(4) : this.textColor(2);
    var color2 = actor.corruption < 0 ? this.textColor(26) : this.textColor(27);

    var rate = Math.abs( actor.corruption / 100 );

    this.drawGauge(x, y, width, rate, color1, color2);
    //this.changeTextColor(this.systemColor());
    //this.drawText("Lust", x, y, 44);
    //this.drawCurrentAndMax(actor._lust, 100, x, y, width, this.hpColor(actor), this.normalColor());
};
 ...
 */
Window_Status.prototype.drawAttributes = function(x, y) {
    
    y += 8;
    var lineHeight = this.lineHeight();

    var corruption = this._actor.corruption;
    var lust = this._actor.lust * 10;
    var chastity = this._actor.chastity * 10;
    this.changeTextColor(this.systemColor());
    this.drawText("Lust", x, y + lineHeight * 0, 270);
    this.drawText("Arousal", x, y + lineHeight * 1, 135);
    this.drawText("Chastity", x + 135, y + lineHeight * 1, 135);
    this.resetTextColor();
    this.drawText(corruption + "%", x, y + lineHeight * 0, 270, 'right');
    this.drawActorLustBar(this._actor, x, y + lineHeight * 0);
    this.drawText(lust + "%", x, y + lineHeight * 1, 120, 'right');
    this.drawText(chastity + "%", x + 135, y + lineHeight * 1, 135, 'right');
};
